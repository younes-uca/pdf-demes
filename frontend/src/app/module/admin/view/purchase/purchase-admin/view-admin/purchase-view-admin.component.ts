...
export class PurchaseViewAdminComponent extends AbstractViewController<PurchaseDto, PurchaseCriteria, PurchaseService> implements OnInit {
    ...
    constructor(private purchaseService: PurchaseService, private purchaseTagService: PurchaseTagService, private purchaseItemService: PurchaseItemService, private clientService: ClientService, private productService: ProductService, private tagService: TagService){
